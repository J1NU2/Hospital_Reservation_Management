...
public class PatientSignUpFrame extends JFrame implements ActionListener {
	...
	private JLabel idCheckLabel = new JLabel();					// 아이디 중복 확인
	...
	private JLabel idenCheckLabel = new JLabel();			// 주민번호 중복 확인
	...
	private JButton idCheckBtn = new JButton("검사");		// 아이디 중복
	private JButton idenCheckBtn = new JButton("검사");		// 주민번호 중복
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == signupBtn) {
			...
			if (signupBlankCheck()) {
				if (!idCheck && pwdCheck && !idenCheck) {
					...
					patientdto.setPwd(pwd2Input.getText());
		...
		} else if (e.getSource() == idCheckBtn) {
		...
		} else if (e.getSource() == idenCheckBtn) {
	...
	public int identityAge(String identity) {
		int age = 0;
	...
	public int birthdayAge(String identity, String year) {
		int age = 0;
		String myYear = null;
	...
	public String identityGender(String identity) {
	...
	public boolean signupBlankCheck() {
		if (idInput.getText().isEmpty() || pwd1Input.getText().isEmpty() || 
				pwd2Input.getText().isEmpty() || nameInput.getText().isEmpty() || 
